...
def triangulate_polygons(nPloy, N_CPU):
	...
	for i in range(N_CPU):
		...
		cmd = lagrit_path + ' < mesh_poly_CPU' + str(i+1) + '.lgi' \
...
lagrit_dfn = os.environ['lagrit_dfn']
lagrit_path = lagrit_dfn
lagrit_merge = lagrit_dfn
...
split_intersection_file_header(intersection_file, N_CPU, nPoly)
